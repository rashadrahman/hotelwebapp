...
//		employee account = new employee();
		...
		String custStreet=req.getParameter("custStreet");
		String custZip=req.getParameter("custZip");
		...
		String[] param = new String[] {custName,custCity,custStreet,custZip,custCountry,custSSN,custPwd};
